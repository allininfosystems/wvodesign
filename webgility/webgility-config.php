...
$wg_config_last_updated_date = '11 March 2016';    
$storeMduleVersion = "338";
$eCCDesktopCompitableVersion = "v3.0 - 4.5.0.0";
$eCCMobileCompitableVersion = "1.5";
$cartCompitableVersion = "Community Edition 1.2.1 to 1.9.2.4,2.0.0 to 2.2.0";
