	...
	public function parseRequest()
	{
		...
		if(!empty($method))
		{
			switch ($method)
			{
				...
				echo $str = $this->$method($username,$password,$datefrom,$start_order_no,$ecc_excl_list,$order_per_response,$storeid,$SelectedOrders,$others['CCDetails'],$others['optionAsItemBundled'],$others['optionAsItemConfigurable'],$others['discountAsItem'],$others['optionAsItem'],$others['DonwloadStateCode'],$LastModifiedDate,$ProductType);
				break;				
...
class Item
{
	...
	{
		$this->Item['CreatedAt'] = $CreatedAt ? $CreatedAt : '';
	}
