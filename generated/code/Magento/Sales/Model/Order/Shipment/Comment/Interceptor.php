...
/**
 * Interceptor class for @see \Magento\Sales\Model\Order\Shipment\Comment
 */
class Interceptor extends \Magento\Sales\Model\Order\Shipment\Comment implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setShipment');
        if (!$pluginInfo) {
            return parent::setShipment($shipment);
        } else {
            return $this->___callPlugins('setShipment', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getIsCustomerNotified');
        if (!$pluginInfo) {
            return parent::getIsCustomerNotified();
        } else {
            return $this->___callPlugins('getIsCustomerNotified', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setIsCustomerNotified');
        if (!$pluginInfo) {
            return parent::setIsCustomerNotified($isCustomerNotified);
        } else {
            return $this->___callPlugins('setIsCustomerNotified', func_get_args(), $pluginInfo);
        }
    }
