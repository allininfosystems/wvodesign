...
class Interceptor extends \Mageplaza\LayeredNavigation\Model\ResourceModel\Fulltext\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getCollectionClone()
    {
        ...
        if (!$pluginInfo) {
            return parent::getCollectionClone();
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAttributeConditionSql');
        if (!$pluginInfo) {
            return parent::getAttributeConditionSql($attribute, $condition, $joinType);
        } else {
            return $this->___callPlugins('getAttributeConditionSql', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSearchCriteriaBuilder');
        if (!$pluginInfo) {
            return parent::getSearchCriteriaBuilder();
        } else {
            return $this->___callPlugins('getSearchCriteriaBuilder', func_get_args(), $pluginInfo);
        }
    }
