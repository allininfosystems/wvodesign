...
class ipb3_002 extends ipb3_000
{
	...
	function ipb3_002(&$displayobject)
	{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		{
			// Get a list of the ipb3 members in this current selection
			$userarray = $this->get_ipb3_members_list($Db_source, $source_database_type, $source_table_prefix, $associate_start_at, $associate_per_page);
