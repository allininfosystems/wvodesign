...
\*======================================================================*/
/**
* jForum_006 Import Thread module
*
...
*
*/
class jForum_006 extends jForum_000
{
	var $_dependent 	= '005';

	function jForum_006(&$displayobject)
	{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$thread_array = $this->get_jForum_thread_details($Db_source, $source_database_type, $source_table_prefix, $thread_start_at, $thread_per_page);
		...
		foreach ($thread_array as $thread_id => $thread_details)
		{
			...
			$try->set_value('nonmandatory', 'sticky',			$thread_details['sticky']); // topic_status ? or open/closed
			$try->set_value('nonmandatory', 'views',			$thread_details['topic_views']);
			$try->set_value('nonmandatory', 'open',				'1'); // topic_status ? or sticky
