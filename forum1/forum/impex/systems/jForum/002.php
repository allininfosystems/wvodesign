...
class jForum_002 extends jForum_000
{
	...
	function jForum_002(&$displayobject)
	{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		{
			// Get a list of the jForum members in this current selection
			$userarray = $this->get_jForum_members_list($Db_source, $source_database_type, $source_table_prefix, $associate_start_at, $associate_per_page);
