...
class dragonfly_003 extends dragonfly_000
{
	var $_dependent = '001';

	function dragonfly_003($displayobject)
	{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		// Get an array data
		$data_array = $this->get_source_data($Db_source, $s_db_type, "{$s_tb_prefix}bbgroups", 'group_id', 0, $start_at, $per_page);
