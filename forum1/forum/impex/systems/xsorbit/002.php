...
*
*/
class xsorbit_002 extends xsorbit_000
{
	var $_dependent 	= '001';


	function xsorbit_002(&$displayobject)
	{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		{
			// Get a list of the xsorbit members in this current selection
			$userarray = $this->get_xsorbit_members_list($Db_source, $source_database_type, $source_table_prefix, $associate_start_at, $associate_per_page);
