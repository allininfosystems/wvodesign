...
\*======================================================================*/
/**
* allaire_002 Import User module
*
...
class allaire_002 extends allaire_000
{
	var $_dependent 	= '001';
	var $_modulestring 	= 'Import User';


	function allaire_002()
	{
		// Constructor
	}
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$user_array 	= $this->get_allaire_user_details($Db_source, $source_database_type, $source_table_prefix, $user_start_at, $user_per_page);
		...
		foreach ($user_array as $user_id => $user_details)
		{
			...
			$try->set_value('mandatory', 'username',				$user_details['Author']);
			...
			if($try->is_valid())
			{
				...
				{
					$displayobject->display_now('<br /><span class="isucc"><b>' . $try->how_complete() . '%</b></span> :: user -> ' . $user_details['Author']);
