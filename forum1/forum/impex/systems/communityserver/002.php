...
* communityserver
/**
* communityserver_001 Associate Users
*
...
*
*/
class communityserver_002 extends communityserver_000
{
	var $_dependent 	= '001';


	function communityserver_002(&$displayobject)
	{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		{
			// Get a list of the communityserver members in this current selection
			$userarray = $this->get_communityserver_members_list($Db_source, $source_database_type, $source_table_prefix, $associate_start_at, $associate_per_page);
