...
*
*/
class vb_36_002 extends vb_36_000
{
	var $_dependent 	= '001';

	function vb_36_002(&$displayobject)
	{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		{
			// Get a list of the vb_36 members in this current selection
			$userarray = $this->get_vb_36_members_list($Db_source, $source_database_type, $source_table_prefix, $associate_start_at, $associate_per_page);
