...
*
*/
class eshare_002 extends eshare_000
{
	var $_dependent 	= '001';


	function eshare_002(&$displayobject)
	{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		{
			// Get a list of the eshare members in this current selection
			$userarray = $this->get_eshare_members_list($Db_source, $source_database_type, $source_table_prefix, $associate_start_at, $associate_per_page);
