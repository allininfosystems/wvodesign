...
\*======================================================================*/
/**
* megaBBS_003 Import Usergroup module
*
...
*
*/
class megaBBS_003 extends megaBBS_000
{
	var $_dependent 	= '001';
	var $_modulestring 	= 'Import Usergroup';

	function megaBBS_003()
	{
		// Constructor
	}
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$usergroup_array 	= $this->get_megaBBS_usergroup_details($Db_source, $source_database_type, $source_table_prefix, $usergroup_start_at, $usergroup_per_page);
