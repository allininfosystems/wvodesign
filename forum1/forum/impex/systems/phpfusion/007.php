...
\*======================================================================*/
/**
* phpfusion_007 Import Post module
*
...
*
*/
class phpfusion_007 extends phpfusion_000
{
	var $_dependent 	= '006';


	function phpfusion_007(&$displayobject)
	{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$post_array 	= $this->get_phpfusion_post_details($Db_source, $source_database_type, $source_table_prefix, $post_start_at, $post_per_page);
		...
		foreach ($post_array as $post_id => $post_details)
		{
			...
			$try->set_value('nonmandatory', 'showsignature',	$post_details['post_showsig']);
			$try->set_value('nonmandatory', 'allowsmilie',		$post_details['post_smileys']);
			$try->set_value('nonmandatory', 'pagetext',			$this->phpfusion_html($post_details['post_message']));
			$try->set_value('nonmandatory', 'dateline',			$post_details['post_datestamp']);
			$try->set_value('nonmandatory', 'title',			$post_details['post_subject']);
