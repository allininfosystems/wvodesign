...
\*======================================================================*/
/**
* phpfusion_006 Import Thread module
*
...
*
*/
class phpfusion_006 extends phpfusion_000
{
	var $_dependent 	= '005';

	function phpfusion_006(&$displayobject)
	{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$thread_array 	= $this->get_phpfusion_thread_details($Db_source, $source_database_type, $source_table_prefix, $thread_start_at, $thread_per_page);
		...
		foreach ($thread_array as $thread_id => $thread_details)
		{
			...
			$try->set_value('mandatory', 'importthreadid',		$thread_details['thread_id']);
			...
			$try->set_value('nonmandatory', 'sticky',			$thread_details['thread_sticky']);
			$try->set_value('nonmandatory', 'views',			$thread_details['thread_views']);
			$try->set_value('nonmandatory', 'open',				($thread_details['thread_locked'] == 1 ? 0 : 1));
