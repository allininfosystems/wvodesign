...
class phpfusion_002 extends phpfusion_000
{
	...
	function phpfusion_002(&$displayobject)
	{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		{
			// Get a list of the phpfusion members in this current selection
			$userarray = $this->get_phpfusion_members_list($Db_source, $source_database_type, $source_table_prefix, $associate_start_at, $associate_per_page);
