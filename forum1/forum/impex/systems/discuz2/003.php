...
\*======================================================================*/
/**
* discuz2_003 Import Usergroup module
*
...
*
*/
class discuz2_003 extends discuz2_000
{
	var $_dependent 	= '001';

	function discuz2_003(&$displayobject)
	{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$usergroup_array 	= $this->get_discuz2_usergroup_details($Db_source, $source_database_type, $source_table_prefix, $usergroup_start_at, $usergroup_per_page);
		...
		foreach ($usergroup_array as $usergroup_id => $usergroup_details)
		{
			...
			// Non Mandatory
			$try->set_value('nonmandatory', 'title',			$usergroup_details['grouptitle']);
			$try->set_value('nonmandatory', 'description',		$usergroup_details['grouptitle'] . ' - imported');
			...
			if($try->is_valid())
			{
				...
				{
					$displayobject->display_now('<br /><span class="isucc"><b>' . $try->how_complete() . '%</b></span>' . $displayobject->phrases['usergroup'] . ' -> ' . $usergroup_details['grouptitle']);
