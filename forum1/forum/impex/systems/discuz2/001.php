...
\*======================================================================*/
/**
* discuz2_001 Check system module
*
...
*
*/
class discuz2_001 extends discuz2_000
{
	var $_version = "0.0.1";
	var $_modulestring 	= 'Check and update database';


	function discuz2_001(&$displayobject)
	{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$this->add_index($Db_target, $target_db_type, $target_table_prefix, 'thread'); // for polls
