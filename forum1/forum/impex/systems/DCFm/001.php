...
*
*/
class DCFm_001 extends DCFm_000
{
	var $_version = "0.0.1";
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$displayobject->display_now("<p> They will also be left after the import if you need to link back to the origional DCFm userid.</p>");
