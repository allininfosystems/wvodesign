...
class vanilla_002 extends vanilla_000
{
	var $_dependent 	= '001';

	function vanilla_002(&$displayobject)
	{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		if ($associate_users == 1)
		{
			...
			$userarray = $this->get_vanilla_members_list($Db_source, $source_database_type, $source_table_prefix, $associate_start_at, $associate_per_page);
