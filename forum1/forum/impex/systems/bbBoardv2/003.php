...
\*======================================================================*/
/**
* bbBoardv2_003 Import User module
*
...
*
*/
class bbBoardv2_003 extends bbBoardv2_000
{
	var $_version 		= '0.0.1';
	var $_dependent 	= '001';
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$user_array 	= $this->get_bbBoardv2_user_details($Db_source, $source_database_type, $source_table_prefix, $user_start_at, $user_per_page);
		...
		foreach ($user_array as $user_id => $user_details)
		{
			...
			$try->set_value('nonmandatory', 'passworddate',			$user_details['registrationtime']);
			...
			$try->set_value('nonmandatory', 'joindate',				$user_details['registrationtime']);
			...
			$try->set_value('nonmandatory', 'birthday_search',		date("Y-m-d",$user_details['birthday_search']));
