...
\*======================================================================*/
/**
* trubb_006 Import Thread module
*
* @package			ImpEx.trubb
...
*
*/
class trubb_006 extends trubb_000
{
	var $_version 		= '0.0.1';
	var $_dependent 	= '005';
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$thread_array 	= $this->get_trubb_thread_details($Db_source, $source_database_type, $source_table_prefix, $thread_start_at, $thread_per_page);
		...
		foreach ($thread_array as $thread_id => $thread_details)
		{
			...
			$try->set_value('nonmandatory', 'lastposter',		$thread_details['lastpostby']);
			$try->set_value('nonmandatory', 'postusername',		$user_name_array["$thread_details[author]"]);
			$try->set_value('nonmandatory', 'postuserid',		$user_ids_array["$thread_details[author]"]);
			$try->set_value('nonmandatory', 'lastpost',			$thread_details['lastpostdate']);
