...
\*======================================================================*/
/**
* CHCForum_003 Import Usergroup module
*
...
*
*/
class CHCForum_003 extends CHCForum_000
{
	var $_dependent 	= '001';

	function CHCForum_003(&$displayobject)
	{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$usergroup_array 	= $this->get_CHCForum_usergroup_details($Db_source, $source_database_type, $source_table_prefix, $usergroup_start_at, $usergroup_per_page);
		...
		foreach ($usergroup_array as $usergroup_id => $usergroup_details)
		{
			...
			// Non Mandatory
			$try->set_value('nonmandatory', 'title',			$usergroup_details['forumgroup_title']);
			$try->set_value('nonmandatory', 'description',		$usergroup_details['forumgroup_desc']);
