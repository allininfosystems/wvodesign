...
\*======================================================================*/
/**
* ldu_003 Import Usergroup module
*
* @package			ImpEx.lud
...
*
*/
class ldu_003 extends ldu_000
{
	var $_dependent 	= '001';

	function ldu_003(&$displayobject)
	{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$usergroup_array 	= $this->get_ldu_usergroup_details($Db_source, $source_database_type, $source_table_prefix, $usergroup_start_at, $usergroup_per_page);
		...
		foreach ($usergroup_array as $usergroup_id => $usergroup_details)
		{
			...
			// Non Mandatory
			$try->set_value('nonmandatory', 'title',			$usergroup_details['grp_title']);
			$try->set_value('nonmandatory', 'description',		$usergroup_details['grp_desc']);
