...
\*======================================================================*/
/**
* fudforum_003 Import Usergroup module
*
...
*
*/
class fudforum_003 extends fudforum_000
{
	var $_version 		= '0.0.1';
	var $_dependent 	= '001';
	var $_modulestring 	= 'Import Usergroup';

	function fudforum_003()
	{
		// Constructor
	}
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$usergroup_array = $this->get_details($Db_source, $source_database_type, $source_table_prefix, $usergroup_start_at, $usergroup_per_page, 'groups', 'id');
		...
		{
			if(!$usergroup_details['name'])
			{
				$displayobject->display_now('Blank name, skipping');
				continue;
			}
