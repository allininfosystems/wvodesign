...
class edge_002 extends edge_000
{
	...
	function edge_002(&$displayobject)
	{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		{
			// Get a list of the edge members in this current selection
			$userarray = $this->get_edge_members_list($Db_source, $source_database_type, $source_table_prefix, $associate_start_at, $associate_per_page);
