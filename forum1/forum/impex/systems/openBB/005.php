...
\*======================================================================*/
/**
* openBB_005 Import Forum module
*
...
*
*/
class openBB_005 extends openBB_000
{
	var $_version 		= '0.0.1';
	var $_dependent 	= '004';
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		if($sessionobject->get_session_var('categoriesfinished') == 'FALSE')
		{
			...
			$categories_array = $this->get_openBB_categories_details($Db_source, $source_database_type, $source_table_prefix);
		...
		else
		{
			...
			// Sort out the forums
			$forum_array  	=  $this->get_openBB_forum_details($Db_source, $source_database_type, $source_table_prefix, $forum_start_at, $forum_per_page);
			...
			foreach ($forum_array as $forum_id => $forum)
			{
				...
				// Need to parse from forum_permissions tables
