...
\*======================================================================*/
/**
* InstantForum_006 Import Thread module
*
...
*
*/
class InstantForum_006 extends InstantForum_000
{
	var $_dependent 	= '005';


	function InstantForum_006(&$displayobject)
	{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$thread_array 	= $this->get_InstantForum_thread_details($Db_source, $source_database_type, $source_table_prefix, $thread_start_at, $thread_per_page);
		...
		foreach ($thread_array as $thread_id => $thread_details)
		{
			...
			$try->set_value('nonmandatory', 'sticky',		$thread_details['IsPinned']);
			...
			$try->set_value('nonmandatory', 'postusername',	$user_name_array["$thread_details[UserID]"]);
