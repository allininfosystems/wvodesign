...
\*======================================================================*/
/**
* InstantForum_007 Import Post module
*
...
*
*/
class InstantForum_007 extends InstantForum_000
{
	var $_dependent 	= '006';


	function InstantForum_007(&$displayobject)
	{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$post_array 	= $this->get_InstantForum_post_details($Db_source, $source_database_type, $source_table_prefix, $post_start_at, $post_per_page);
		...
		foreach ($post_array as $post_id => $post_details)
		{
			...
			$try->set_value('nonmandatory', 'pagetext',		$this->InstantForum_html($this->html_2_bb($post_details['Message'])));
