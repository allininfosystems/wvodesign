...
\*======================================================================*/
/**
* webwiz_006 Import Thread module
*
...
*
*/
class webwiz_006 extends webwiz_000
{
	var $_version 		= '0.0.1';
	var $_dependent 	= '005';
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$thread_array 	= $this->get_webwiz_thread_details($Db_source, $source_database_type, $source_table_prefix, $thread_start_at, $thread_per_page);
		...
		foreach ($thread_array as $thread_id => $thread_details)
		{
			...
			$try->set_value('nonmandatory', 'pollid',			$thread_details['Poll_ID']);
			...
			$try->set_value('nonmandatory', 'dateline',			$this->fix_time($thread_details['Start_date']));
			$try->set_value('nonmandatory', 'views',			$thread_details['No_of_views']);
