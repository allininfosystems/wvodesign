...
$config['Database']['dbname'] = 'wvodesig_forum';
...
$config['Database']['technicalemail'] = 'leon@wvodesigns.com';
...
$config['MasterServer']['username'] = 'wvodesig_forum';
$config['MasterServer']['password'] = 'X&heT!pULUIs';
