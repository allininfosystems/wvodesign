...
define('FILE_VERSION', '4.1.2'); // this should match installsteps.php
define('SIMPLE_VERSION', '412'); // see vB_Datastore::check_options()
...
*
* @package	vBulletin
* @version	$Revision: 41708 $
* @date		$Date: 2011-02-10 11:50:11 -0800 (Thu, 10 Feb 2011) $
*/
class vB_Database
{
	/**
...
//				$output_type = in_array($vbulletin->GPC['api'], array('xml', 'json')) ? $vbulletin->GPC['api'] : 'json';
	...
	*/
	...
	{
		if (!isset(self::$hook_code) AND class_exists('vBulletinHook', false))
		{
			self::$hook_code = vBulletinHook::fetch_hook('template_register_var');
		}
		else
		{
			self::$hook_code = false;
		}
	}
