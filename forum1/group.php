...
if (!empty($_POST['do']) AND $_POST['do'] == 'dotransfer')
{
	...
	else
	{
		...
		$pmdm->set('message', construct_phrase($vbphrase['pm_request_to_take_ownership_of_social_group_message'],
...
if (!empty($_POST['do']) AND $_POST['do'] == 'doaccepttransfer')
{
	...
	if ($vbulletin->GPC['confirm'])
	{
		...
		$pmdm->set('message', construct_phrase($vbphrase['pm_request_to_take_ownership_of_social_group_accepted_message'],
