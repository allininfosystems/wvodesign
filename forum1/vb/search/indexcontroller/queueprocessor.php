 ...
 * @version $Id: queueprocessor.php 92140 2016-12-31 04:26:15Z pmarsden $
 * @access public
 */
...
// ###################### Start index ######################
	...
	public static function index()
	{
		...
		while ($row = $db->fetch_array($rst))
		{
			...
			$row['data'] = vb_unserialize($row['data']);
	...
	public static function indexNow($package, $contenttype, $operation, $data)
	{
		if (isset($package) AND isset($contenttype) AND isset($operation))
		{
			...
			if ($indexcontroller instanceof vb_Search_Indexcontroller_Null)
			{
				return false;
			}
