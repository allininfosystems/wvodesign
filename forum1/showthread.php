...
if ($thread['pollid'])
{
	...
	foreach ($splitvotes AS $index => $value)
	{
		...
		// public link
		if ($pollinfo['public'] AND $value AND !VB_API)
		{
...
$vbulletin->options['apipostidmanage'] = vb_unserialize($vbulletin->options['apipostidmanage']);
...
/*======================================================================*\
|| ####################################################################
|| # Downloaded: 10:21, Mon Dec 11th 2017 : $Revision: 92547 $
|| # $Date: 2017-01-23 07:03:30 -0800 (Mon, 23 Jan 2017) $
|| ####################################################################
\*======================================================================*/
