...
if ($vbulletin->options['reputationenable'])
{
	...
	$reputations = $db->query_read_slave("
		SELECT
			...
			user.userid, user.username, post.threadid, thread.title, thread.threadid, thread.forumid, post.userid AS postuserid
...
/*======================================================================*\
|| ####################################################################
|| # Downloaded: 10:21, Mon Dec 11th 2017 : $Revision: 92942 $
|| # $Date: 2017-02-16 06:09:28 -0800 (Thu, 16 Feb 2017) $
|| ####################################################################
\*======================================================================*/
