...
function &retrieve_vbfields_queries($tableprefix = '')
{
	...
	$queries[] = "INSERT INTO {$tableprefix}vbfields VALUES ('comments_visible', 'blog', 'N', '1', 'return true;', 'blog')";
	...
	$queries[] = "INSERT INTO {$tableprefix}vbfields VALUES ('allowsmilie', 'blog_user', 'N', 'title', 'return true;', 'blog')";
	...
	$queries[] = "INSERT INTO {$tableprefix}vbfields VALUES ('title', 'blog_text', 'Y', 'Blog title', 'return true;', 'blog')";
	...
	$queries[] = "INSERT INTO {$tableprefix}vbfields VALUES ('bloguserid', 'blog_text', 'Y', '!##NULL##!', 'return true;', 'blog')";
	...
	$queries[] = "INSERT INTO {$tableprefix}vbfields VALUES ('userid', 'blog_category', 'N', '!##NULL##!', 'return true;', 'blog')";
	...
	*/
	...
	# cms_article
	$queries[] = "INSERT INTO {$tableprefix}vbfields VALUES ('importcmsarticleid', 'cms_article', 'Y', '-1', 'return true;', 'cms')";
	$queries[] = "INSERT INTO {$tableprefix}vbfields VALUES ('pagetext', 'cms_article', 'Y', '', 'return true;', 'cms')";
	$queries[] = "INSERT INTO {$tableprefix}vbfields VALUES ('title', 'cms_article', 'Y', '', 'return true;', 'cms')";
	$queries[] = "INSERT INTO {$tableprefix}vbfields VALUES ('postauthor', 'cms_article', 'Y', '0', 'return true;', 'cms')";
	$queries[] = "INSERT INTO {$tableprefix}vbfields VALUES ('previewtext', 'cms_article', 'Y', '', 'return true;', 'cms')";
	$queries[] = "INSERT INTO {$tableprefix}vbfields VALUES ('created', 'cms_article', 'N', '0', 'return true;', 'cms')";
