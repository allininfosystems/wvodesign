...
\*======================================================================*/
/**
* xoops_005 Import Thread module
*
* @package			ImpEx.xoops
...
*
*/
class xoops_005 extends xoops_000
{
	var $_version 		= '0.0.1';
	var $_dependent 	= '004';
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$thread_array 	= $this->get_xoops_thread_details($Db_source, $source_database_type, $source_table_prefix, $thread_start_at, $thread_per_page);
		...
		foreach ($thread_array as $thread_id => $thread_details)
		{
			...
			if($thread_details['topic_status'])
			{
			...
			$try->set_value('nonmandatory', 'dateline',			$thread_details['topic_time']);
			...
			$try->set_value('nonmandatory', 'sticky',			$thread_details['topic_sticky']);
