...
\*======================================================================*/
/**
* phorum5_005 Import Thread module
*
...
*
*/
class phorum5_005 extends phorum5_000
{
	var $_version 		= '0.0.1';
	var $_dependent 	= '004';
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$thread_array 	= $this->get_phorum5_thread_details($Db_source, $source_database_type, $source_table_prefix, $thread_start_at, $thread_per_page);
		...
		foreach ($thread_array as $thread_id => $thread_details)
		{
			...
			$try->set_value('nonmandatory', 'views',			$thread_details['viewcount']);
			$try->set_value('nonmandatory', 'dateline',			$thread_details['datestamp']);
