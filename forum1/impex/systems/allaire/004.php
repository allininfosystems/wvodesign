...
\*======================================================================*/
/**
* allaire_004 Import Thread module
*
...
class allaire_004 extends allaire_000
{
	var $_dependent 	= '003';
	var $_modulestring 	= 'Import Thread';


	function allaire_004()
	{
		// Constructor
	}
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$thread_array 	= $this->get_allaire_thread_details($Db_source, $source_database_type, $source_table_prefix, $thread_start_at, $thread_per_page);
		...
		foreach ($thread_array as $thread_id => $thread_details)
		{
			...
			// Non Mandatory
			$try->set_value('nonmandatory', 'open',				$thread_details['IsActive']);
