...
class webbbs_001 extends webbbs_000
{
	function webbbs_001(&$displayobject)
	{
	...
	function init(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$displayobject->update_html($displayobject->make_input_code('Full Path to webbbs root folder (the one that contains main/)','rootpath',$sessionobject->get_session_var('rootpath'),1,60));
	...
	*/
		...
		$databasedone 	=	$this->check_path($displayobject, $sessionobject, $rootpath);
