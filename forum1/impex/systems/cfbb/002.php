...
class cfbb_002 extends cfbb_000
{
	...
	function cfbb_002(&$displayobject)
	{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		{
			// Get a list of the cfbb members in this current selection
			$userarray = $this->get_cfbb_members_list($Db_source, $source_database_type, $source_table_prefix, $associate_start_at, $associate_per_page);
