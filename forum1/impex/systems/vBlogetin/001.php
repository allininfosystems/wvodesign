...
class vBlogetin_001 extends vBlogetin_000
{
	function vBlogetin_001(&$displayobject)
	{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$this->check_product_installed($Db_target, $target_db_type, $target_table_prefix, 'blog');
