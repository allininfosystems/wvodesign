...
\*======================================================================*/
/**
* simpleboard_006 Import Post module
*
...
*
*/
class simpleboard_006 extends simpleboard_000
{
	var $_version 		= '0.0.1';
	var $_dependent 	= '005';
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$post_array 	= $this->get_simpleboard_post_details($Db_source, $source_database_type, $source_table_prefix, $post_start_at, $post_per_page);
		...
		foreach ($post_array as $post_id => $post_details)
		{
			...
			// Non Mandatory
			if ($post_details['parent'] == $post_details['thread'])
			{
			...
			$try->set_value('nonmandatory', 'dateline',			$post_details['time']);
