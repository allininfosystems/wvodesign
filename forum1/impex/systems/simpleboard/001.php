...
\*======================================================================*/
/**
* simpleboard_001 Check system module
*
...
*
*/
class simpleboard_001 extends simpleboard_000
{
	var $_version = "0.0.1";
	var $_modulestring 	= 'Check and update database';


	function simpleboard_001()
	{
	}
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		if($sessionobject->get_session_var('added_default_unknown_group') != 'yup')
		{
			...
			$try->set_value('nonmandatory', 'title',				'Imported Admins');
