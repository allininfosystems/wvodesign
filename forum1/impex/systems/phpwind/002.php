...
*
*/
class phpwind_002 extends phpwind_000
{
	var $_dependent 	= '001';

	function phpwind_002(&$displayobject)
	{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		{
			// Get a list of the phpwind members in this current selection
			$userarray = $this->get_phpwind_members_list($Db_source, $source_database_type, $source_table_prefix, $associate_start_at, $associate_per_page);
