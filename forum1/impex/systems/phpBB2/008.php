...
class phpBB2_008 extends phpBB2_000
{
	var $_dependent 	= '001';

	function phpBB2_008(&$displayobject)
	{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$smilie_array 			= $this->get_phpbb2_smilie_details($Db_source, $source_database_type, $source_table_prefix);
		...
		foreach ($smilie_array as $smilie_id => $smilie)
		{
			...
			$pass_array = array('title'	=> $smilie['emoticon'], 'smilietext' => $smilie['code'], 'smiliepath' => $smilie['smile_url']);
