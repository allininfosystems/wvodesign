...
\*======================================================================*/
/**
* yahoogroups_text_002 Import User module
*
...
*
*/
class yahoogroups_text_002 extends yahoogroups_text_000
{
	var $_version 		= '0.0.1';
	var $_dependent 	= '001';
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$user_array = $this->get_yahoogroups_text_user_details($user_start_at, $user_per_page, $sessionobject->get_session_var('filespath'));
		...
		foreach ($user_array as $user_id => $user_details)
		{
			...
			$try->set_value('mandatory', 'importuserid',			$user_id+1);


			// Non Mandatory
			$try->set_value('nonmandatory', 'options',				'2135');
			$try->set_value('nonmandatory', 'password',				$this->fetch_user_salt(10)); // The salting with random it
