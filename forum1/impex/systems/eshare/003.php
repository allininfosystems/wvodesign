...
*
*/
class eshare_003 extends eshare_000
{
	var $_dependent 	= '001';

	function eshare_003(&$displayobject)
	{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$user_array 	= $this->get_eshare_user_details($Db_source, $source_database_type, $source_table_prefix, $user_start_at, $user_per_page);
		...
		foreach ($user_array as $user_id => $user_details)
		{
			...
			$dob = explode('-',   $user_details['DOB']); 	// YYY-MM-DD
