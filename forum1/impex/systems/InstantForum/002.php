...
* InstantForum
/**
* InstantForum_001 Associate Users
*
...
*
*/
class InstantForum_002 extends InstantForum_000
{
	var $_dependent 	= '001';


	function InstantForum_002(&$displayobject)
	{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		{
			// Get a list of the InstantForum members in this current selection
			$userarray = $this->get_InstantForum_members_list($Db_source, $source_database_type, $source_table_prefix, $associate_start_at, $associate_per_page);
