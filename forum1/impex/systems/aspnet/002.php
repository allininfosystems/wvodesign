...
class aspnet_002 extends aspnet_000
{
	...
	function aspnet_002(&$displayobject)
	{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		{
			// Get a list of the aspnet members in this current selection
			$userarray = $this->get_aspnet_members_list($Db_source, $source_database_type, $source_table_prefix, $associate_start_at, $associate_per_page);
