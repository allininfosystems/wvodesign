...
\*======================================================================*/
/**
* oxygen_010 Import Attachment module
*
...
*
*/
class oxygen_010 extends oxygen_000
{
	var $_version 		= '0.0.1';
	var $_dependent 	= '007';
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$attachment_array 	= $this->get_oxygen_attachment_details($Db_source, $source_database_type, $source_table_prefix, $attachment_start_at, $attachment_per_page);
