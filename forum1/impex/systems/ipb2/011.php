...
\*======================================================================*/
/**
* ipb2_011 Import Attachment module
*
* @package			ImpEx.ipb2
...
*
*/
class ipb2_011 extends ipb2_000
{
	var $_dependent 	= '007';

	function ipb2_011(&$displayobject)
	{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$attachment_array 		= $this->get_ipb2_attachment_details($Db_source, $source_database_type, $source_table_prefix, $attachment_start_at, $attachment_per_page);
		...
		foreach ($attachment_array as $attachment_id => $attachment_details)
		{
			...
			else if (is_numeric($attachment_details['attach_rel_id']) AND trim(strtolower($attachment_details['attach_rel_module'])) == 'post')
			{
