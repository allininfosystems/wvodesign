...
\*======================================================================*/
/**
* smf_003 Import Usergroup module
*
* @package			ImpEx.smf
...
*
*/
class smf_003 extends smf_000
{
	var $_dependent 	= '001';

	function smf_003(&$displayobject)
	{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$usergroup_array 	= $this->get_smf_usergroup_details($Db_source, $source_database_type, $source_table_prefix, $usergroup_start_at, $usergroup_per_page);
