...
\*======================================================================*/
/**
* discus_file Check system module
*
...
*
*/
class discus_file_001 extends discus_file_000
{
	var $_version = "0.0.1";
	...
	function init(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$displayobject->update_html($displayobject->make_input_code('Full Path to discus messages folder (where the board-topics.html file is located)','messagesspath',$sessionobject->get_session_var('messagesspath'),1,60));
		$displayobject->update_html($displayobject->make_input_code('Full Path to discus admin folder (where the users.txt file is located)','adminpath',$sessionobject->get_session_var('adminpath'),1,60));
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$result = $this->check_path($displayobject, $sessionobject, $sessionobject->get_session_var('messagesspath'));
...
# Autogenerated on : May 17, 2004, 1:42 pm
