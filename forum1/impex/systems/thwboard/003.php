...
\*======================================================================*/
/**
* thwboard_003 Import Usergroup module
*
...
*
*/
class thwboard_003 extends thwboard_000
{
	var $_version 		= '0.0.1';
	var $_dependent 	= '001';
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$usergroup_array 	= $this->get_thwboard_usergroup_details($Db_source, $source_database_type, $source_table_prefix, $usergroup_start_at, $usergroup_per_page);
		...
		foreach ($usergroup_array as $usergroup_id => $usergroup_details)
		{
			...
			// Mandatory
			$try->set_value('mandatory', 'importusergroupid',			$usergroup_details['groupid']);


			// Non Mandatory
			if($usergroup_details['title'])
			{
			...
			/*
			// TODO: Need to parse the  accessmask into the permissionss
