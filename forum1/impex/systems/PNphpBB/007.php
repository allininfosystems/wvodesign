...
\*======================================================================*/
/**
* PNphpBB_007 Import Smilie module
*
...
*
*/
class PNphpBB_007 extends PNphpBB_000
{
	var $_version 		= '0.0.1';
	var $_dependent 	= '001';
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		foreach ($smilie_array as $smilie_id => $smilie_details)
		{
			...
			$pass_array = array(
				'title'			=> $smilie_details['emoticon'],
				'smilietext' 	=> $smilie_details['code'],
				'smiliepath' 	=> $smilie_details['smile_url']
			);
