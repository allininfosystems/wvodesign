...
*
*/
class MxBoard_002 extends MxBoard_000
{
	var $_dependent 	= '001';


	function MxBoard_002(&$displayobject)
	{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		{
			// Get a list of the MxBoard members in this current selection
			$userarray = $this->get_MxBoard_members_list($Db_source, $source_database_type, $source_table_prefix, $associate_start_at, $associate_per_page);
