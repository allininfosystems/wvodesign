...
class bac_002 extends bac_000
{
	...
	function bac_002(&$displayobject)
	{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		{
			// Get a list of the bac members in this current selection
			$userarray = $this->get_bac_members_list($Db_source, $source_database_type, $source_table_prefix, $associate_start_at, $associate_per_page);
