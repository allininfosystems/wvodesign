...
*
*/
class bac_006 extends bac_000
{
	var $_dependent 	= '005';

	function bac_006(&$displayobject)
	{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$post_array 		= $this->get_bac_post_details($Db_source, $source_database_type, $source_table_prefix, $post_start_at, $post_per_page);
		...
		foreach ($post_array as $post_id => $post_details)
		{
			...
			#$try->set_value('nonmandatory', 'iconid',			$post_details['iconid']); PostTypeID
			...
			$try->set_value('nonmandatory', 'username',			$post_details['AuthorName']);
