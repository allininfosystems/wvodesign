...
class wbb3_001 extends wbb3_000
{
	function wbb3_001(&$displayobject)
	{
	...
	function init(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$displayobject->update_html($displayobject->make_input_code('The table prefix for the installed wBB3 forum', 'forum_prefix', 'wbb1_1_'));
