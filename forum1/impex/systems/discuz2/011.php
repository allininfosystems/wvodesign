...
\*======================================================================*/
/**
* discuz2_011 Import Smilie module
*
...
*
*/
class discuz2_011 extends discuz2_000
{
	var $_dependent 	= '001';


	function discuz2_011(&$displayobject)
	{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$smilie_array 	= $this->get_discuz2_smilie_details($Db_source, $source_database_type, $source_table_prefix, $smilie_start_at, $smilie_per_page);
