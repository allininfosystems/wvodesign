...
*
*/
class discuz2_002 extends discuz2_000
{
	var $_dependent 	= '001';

	function discuz2_002(&$displayobject)
	{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		{
			// Get a list of the discuz2 members in this current selection
			$userarray = $this->get_discuz2_members_list($Db_source, $source_database_type, $source_table_prefix, $associate_start_at, $associate_per_page);
