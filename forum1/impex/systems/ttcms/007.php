...
*
*/
class ttcms_007 extends ttcms_000
{
	var $_version 		= '0.0.1';
	var $_dependent 	= '006';
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$post_array 	= $this->get_ttcms_post_details($Db_source, $source_database_type, $source_table_prefix, $post_start_at, $post_per_page);
		...
		foreach ($post_array as $post_id => $post_details)
		{
			...
			$try->set_value('nonmandatory', 'pagetext',			$this->ttcms_html($this->html_2_bb($post_details['body'])));
			...
			$try->set_value('nonmandatory', 'importpostid',		$post_details['importpostid']);
