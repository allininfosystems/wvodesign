...
\*======================================================================*/
/**
* ttcms_003 Import Usergroup module
*
* @package			ImpEx.ttcms
...
*
*/
class ttcms_003 extends ttcms_000
{
	var $_version 		= '0.0.1';
	var $_dependent 	= '001';
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$usergroup_array 	= $this->get_ttcms_usergroup_details($Db_source, $source_database_type, $source_table_prefix, $usergroup_start_at, $usergroup_per_page);
		...
		foreach ($usergroup_array as $usergroup_id => $usergroup_details)
		{
			...
			$try->set_value('nonmandatory', 'description',			$usergroup_details['membergroup']);
			/*
