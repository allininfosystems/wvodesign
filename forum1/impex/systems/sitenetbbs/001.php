...
\*======================================================================*/
/**
* sitenetbbs_001 Check system module
*
...
*
*/
class sitenetbbs_001 extends sitenetbbs_000
{
	var $_version = "0.0.1";
	var $_modulestring 	= 'Check and update database';


	function sitenetbbs_001()
	{
	}
	...
	function init(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$displayobject->update_html($displayobject->make_description('This module will check the paths and files as well as the connection.'));
		$displayobject->update_html($displayobject->make_input_code('Full Path to admin/data folder','admindata',$sessionobject->get_session_var('admindata'),1,60));
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$databasedone =	$this->check_path($displayobject, $sessionobject, $sessionobject->get_session_var('admindata'));
