...
\*======================================================================*/
/**
* phpfusion_003 Import Usergroup module
*
...
*
*/
class phpfusion_003 extends phpfusion_000
{
	var $_dependent 	= '001';

	function phpfusion_003(&$displayobject)
	{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$usergroup_array 	= $this->get_phpfusion_usergroup_details($Db_source, $source_database_type, $source_table_prefix, $usergroup_start_at, $usergroup_per_page);
