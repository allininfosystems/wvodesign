...
\*======================================================================*/
/**
* bbBoardv2_005 Import Thread module
*
...
*
*/
class bbBoardv2_005 extends bbBoardv2_000
{
	var $_version 		= '0.0.1';
	var $_dependent 	= '004';
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$thread_array 	= $this->get_bbBoardv2_thread_details($Db_source, $source_database_type, $source_table_prefix, $thread_start_at, $thread_per_page);
		...
		foreach ($thread_array as $thread_id => $thread_details)
		{
			...
			$try->set_value('mandatory', 'importthreadid',		$thread_details['gpid']);
			...
			$try->set_value('nonmandatory', 'dateline',			$thread_details['postedbytime']);
