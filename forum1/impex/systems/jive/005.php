...
class jive_005 extends jive_000
{
	var $_dependent = '004';

	function jive_005(&$displayobject)
	{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		// Get an array data
		$data_array = $this->get_jive_thread_details($Db_source, $s_db_type, $s_tb_prefix, $start_at, $per_page);
