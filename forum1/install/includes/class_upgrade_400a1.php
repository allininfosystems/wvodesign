...
class vB_Upgrade_400a1 extends vB_Upgrade_Version
{
	...
	*/
	function step_8()
	{
		$this->run_query(
			...
			"ALTER TABLE " . TABLE_PREFIX . "reputation ADD UNIQUE INDEX whoadded_postid (whoadded, postid)",
	...
	*/
	function step_110()
	{
		$canignorequotaperm = intval(vB::$vbulletin->bf_ugp_pmpermissions['canignorequota']);
