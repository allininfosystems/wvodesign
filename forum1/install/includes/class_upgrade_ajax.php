...
class vB_Upgrade_Ajax extends vB_Upgrade_Abstract
{
	...
	*/
	...
	{
		parent::init();
		$this->custnumber = (strlen('257a9d98d20d637a8727518db3ffeaca') == 32) ? '257a9d98d20d637a8727518db3ffeaca' : md5(strtoupper('257a9d98d20d637a8727518db3ffeaca'));
	...
	*/
	protected function begin_upgrade($version, $only = false)
	{
		...
		else
		{
			...
			{
				$addscripts = array('skimlinks', 'forumrunner', 'final');
	...
	*/
	private function login()
	{
		if (isset($_POST['customerid']))
		{
			...
			{
				setcookie('bbcustomerid', $this->custnumber, 0, '/', '', false, true);
				return true;
			}
			else
			{
...
/*======================================================================*\
|| ####################################################################
|| # Downloaded: 10:21, Mon Dec 11th 2017 : $Revision: 92252 $
|| # $Date: 2017-01-04 17:50:29 -0800 (Wed, 04 Jan 2017) $
|| ####################################################################
\*======================================================================*/
