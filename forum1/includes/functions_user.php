...
/*
	function fetch_user_salt no longer exists, and is handled in class_dm_user, fetch_user_salt($length)
*/

/*
	function verify_profilefields no longer exists, and is handled by vB_DataManager_User::set_userfields($values)
*/
