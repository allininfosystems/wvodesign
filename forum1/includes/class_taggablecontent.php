	...
	*/
	protected static function convert_synonyms($tags, &$errors)
	{
		...
		foreach ($tags as $key => $tag)
		{
			...
			{
				/* Removed error messages as they stop posting, and there seems no useful purpose to them. */
				//$errors["$tag_lower-convert"] = array('tag_x_converted_to_y', $tag, $map[$tag_lower]); // VBIV-15929
