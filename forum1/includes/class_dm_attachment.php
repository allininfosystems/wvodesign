...
*
* @package	vBulletin
* @version	$Revision: 93970 $
* @date		$Date: 2017-05-08 16:49:09 -0700 (Mon, 08 May 2017) $
*/
...
class vB_DataManager_Filedata extends vB_DataManager_AttachData
{
	...
	*/
	...
	{
		return parent::pre_delete('filedata', $doquery, $checkperms);
	}

	public function delete($doquery = true, $checkperms = true)
	{
		if (!$this->pre_delete($doquery, $checkperms) OR empty($this->lists['filedataids']))
		{
			return false;
		}
...
/*======================================================================*\
|| ####################################################################
|| # Downloaded: 10:21, Mon Dec 11th 2017 : $Revision: 93970 $
|| # $Date: 2017-05-08 16:49:09 -0700 (Mon, 08 May 2017) $
|| ####################################################################
\*======================================================================*/
?>
