...
function print_setting_row($setting, $settingphrase, $option_config = true)
{
	...
	switch ($setting['optioncode'])
	{
		...
		case 'usergroups:none':
		{
			...
			print_select_row($description, $name.'[]', $array, vb_unserialize($setting['value']), false, ($size > 10 ? 10 : $size), true);
		}
		break;
...
/*======================================================================*\
|| ####################################################################
|| # Downloaded: 10:21, Mon Dec 11th 2017 : $Revision: 92955 $
|| # $Date: 2017-02-16 19:28:42 -0800 (Thu, 16 Feb 2017) $
|| ####################################################################
\*======================================================================*/
