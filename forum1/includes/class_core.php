...
define('FILE_VERSION', '4.2.5'); // this should match installsteps.php
define('SIMPLE_VERSION', '425'); // see vB_Datastore::check_options()
...
class vB_Database_MySQLi extends vB_Database
{
	...
	* @param	string  Username to connect to the database server
	* @param	string  Password associated with the username for the database server
	* @param	string  Persistent Connections - Only supported by MySQLi in php 5.3+
...
class vB_Input_Cleaner
{
	...
	*/
	function __construct(&$registry)
	{
		...
		if ($_SERVER['REQUEST_METHOD'] == 'POST' AND !empty($_SERVER['HTTP_X_REQUESTED_WITH']) AND $_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest' AND
	...
	function resolve_request_url($registry)
	{
		...
		$url_info = $url_info ? $url_info : array(); // PHP 7.1 fix, force empty array.
...
/*======================================================================*\
|| ####################################################################
|| # Downloaded: 10:21, Mon Dec 11th 2017 : $Revision: 93876 $
|| # $Date: 2017-04-29 04:50:15 -0700 (Sat, 29 Apr 2017) $
|| ####################################################################
\*======================================================================*/
