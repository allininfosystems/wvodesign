...
function install_product($xml, $allow_overwrite)
{
	...
	if (isset($arr['templates_mobile']['template']) AND is_array($arr['templates_mobile']['template']))
	{
	...
	if (isset($arr['stylevars']['stylevar']) AND is_array($arr['stylevars']['stylevar']))
	{
		xml_import_stylevars($arr['stylevars'], -1);
	}

	if (isset($arr['stylevardfns_mobile']['stylevargroup']) AND is_array($arr['stylevardfns_mobile']['stylevargroup']))
	{
		xml_import_stylevar_definitions($arr['stylevardfns_mobile'], $info['productid'], -2);
	}

	if (isset($arr['stylevars_mobile']['stylevar']) AND is_array($arr['stylevars_mobile']['stylevar']))
	{
...
function import_navigation($arr, $info)
{
	...
	// ### Import Tabs ###
	if (isset($navarray['tab']) AND is_array($navarray['tab']))
	{
	...
	// ### Import Menus ###
	if (isset($navarray['menu']) AND is_array($navarray['menu']))
	{
	...
	// ### Import Links ###
	if (isset($navarray['link']) AND is_array($navarray['link']))
	{
