...
if ($_REQUEST['do'] == 'top')
{
	...
	$linktext = construct_link_code(
		htmlspecialchars_uni($maxclient['clientname']) . " ($vbphrase[id]: " . $maxclient['apiclientid'] . ')',
	...
	print_label_row($vbphrase['top_apimethod'], htmlspecialchars_uni($maxmethod['method']) . " (" . construct_phrase($vbphrase['api_x_calls'], $maxclient['c']) . ")");
	print_table_footer();
