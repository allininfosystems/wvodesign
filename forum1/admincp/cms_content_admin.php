...
if (!($vbulletin->userinfo['permissions']['cms']['canview'][0] > 0))
{
	// Most likely a call from ajax.php, so just send back a simple text error.
	echo 'No CMS View Permission';
	exit;
}
...
switch($vbulletin->GPC['do'])
{
	...
	case 'find_categories': //This is called from ajax.php to list categories for the
