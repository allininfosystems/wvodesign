...
if ($_REQUEST['do'] == 'edit')
{
	...
	$translations = '&nbsp;<span class="smallfont"><a href="phrase.php?do=edit&fieldname=global&varname=vb_navigation_'.$navelement['navtype'].'_'.$navelement['name'].'_text&t=1" target="_blank">['.$vbphrase['translations'].']</a></span>';
	print_input_row($vbphrase['title'], 'title', $navelement['text'], true, 50, 0, '', false, false, $translations);
