...
function getCheckbox($name, $value = 1, $checked = true, array $attributes = null)
{
	...
	if (is_array($attributes))
	{
		...
		{
			$attributeString .= " $attribute=\"" . htmlspecialchars_uni($value) . "\"";
		}
	}
...
if ($_POST['do'] == 'update')
{
	...
	switch ($option_type)
	{
		...
		{
			$inputArray = array(
				'skimlinks_disable_groups'           => TYPE_STR,
				'skimwords_disable_groups'           => TYPE_STR,
				'skimlinks_disable_groups_parse'     => TYPE_STR,
				'skimwords_disable_groups_parse'     => TYPE_STR,
				'skimlinks_disable_forums'           => TYPE_STR,
				'skimwords_disable_forums'           => TYPE_STR,
