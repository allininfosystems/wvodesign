...
define('CVS_REVISION', '$RCSfile$ - $Revision: 93571 $');
	...
	if ($db->num_rows($logs))
	{
		...
		if ($vbulletin->GPC['pagenumber'] != 1)
		{
			...
			$firstpage = "<input type=\"button\" class=\"button\" value=\"&laquo; " . $vbphrase['first_page'] .
				"\" tabindex=\"1\" onclick=\"window.location='modlog.php?" . $vbulletin->session->vars['sessionurl'] .
				"do=view&modaction=" . $vbulletin->GPC['modaction'] .
		...
		if ($vbulletin->GPC['pagenumber'] != $totalpages)
		{
			...
			$lastpage = "<input type=\"button\" class=\"button\" value=\"" . $vbphrase['last_page'] .
				" &raquo;\" tabindex=\"1\" onclick=\"window.location='modlog.php?" . $vbulletin->session->vars['sessionurl'] .
				"do=view&modaction=" . $vbulletin->GPC['modaction'] .
				"&u=" . $vbulletin->GPC['userid'] .
				"&pp=" . $vbulletin->GPC['perpage'] .
				"&orderby=" . $vbulletin->GPC['orderby'] .
...
/*======================================================================*\
|| ####################################################################
|| # Downloaded: 10:21, Mon Dec 11th 2017 : $Revision: 93571 $
|| # $Date: 2017-04-01 13:47:49 -0700 (Sat, 01 Apr 2017) $
|| ####################################################################
\*======================================================================*/
?>
