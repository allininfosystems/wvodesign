...
define('CVS_REVISION', '$RCSfile$ - $Revision: 92648 $');
...
if ($_REQUEST['do'] == 'head')
{
	...
	<tr align="center" valign="top">
		<td style="text-align:<?php echo vB_Template_Runtime::fetchStyleVar('left'); ?>"><a href="https://www.vbulletin.com/" target="_blank"><b><?php echo $vbphrase['admin_control_panel']; ?></b> (vBulletin <?php echo ADMIN_VERSION_VBULLETIN . print_form_middle('VBF6025393'); ?>)<?php echo iif(is_demo_mode(), ' <b>DEMO MODE</b>'); ?></a></td>
	...
	<script type="text/javascript" src="<?php echo $versionhost; ?>/version.js?v=<?php echo SIMPLE_VERSION; ?>&amp;id=VBF6025393&amp;pid=vbforum_4"></script>
...
if ($_REQUEST['do'] == 'nav')
{
	...
	echo "\n<div>";
	?><img src="../cpstyles/<?php echo $vbulletin->options['cpstylefolder']; ?>/cp_logo.gif" title="<?php echo $vbphrase['admin_control_panel']; ?>" alt="" border="0" hspace="4" <?php $df = print_form_middle("VBF6025393"); ?> vspace="4" /><?php
...
if ($db->num_rows($adminmessages_result))
{
	...
	while ($adminmessage = $db->fetch_array($adminmessages_result))
	{
		...
		$args = vb_unserialize($adminmessage['args']);
...
print_label_row($vbphrase['php_function_lookup'], '
	<form action="//www.ph' . 'p.net/manual-lookup.ph' . 'p" method="get" style="display:inline">
...
print_label_row($vbphrase['mysql_language_lookup'], '
	<form action="//www.mysql.com/search/" method="get" style="display:inline">
...
/*======================================================================*\
|| ####################################################################
|| # Downloaded: 10:21, Mon Dec 11th 2017 : $Revision: 92648 $
